...
test("sync root perm",function(a){a.plan(3);mkdirp.sync("/tmp",_0755);exists("/tmp",function(b){a.ok(b,"file created");fs.stat("/tmp",function(b,d){a.ifError(b);a.ok(d.isDirectory(),"target not a directory")})})}); //# sourceMappingURL=perm_sync.js.map
