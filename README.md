...
See the requirements used to build both the server and web app here [https://github.com/GrokSoft/RESTExample/blob/master/Requirements.MD](https://github.com/GrokSoft/RESTExample/blob/master/Requirements.MD)
